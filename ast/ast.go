...
type ExpressionStatement struct {
	Token      token.Token // the first token of the Expression,inherited from Token
...
// to handle if elif elif ... else condition,
// move Condition:Consequence into another structure and make an ordered array
// we can check index by index for a matching Condition. Else go Alternative
...
type ExpressionPairs map[Expression]Expression
